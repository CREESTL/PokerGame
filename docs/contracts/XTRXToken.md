...
```solidity
function burnTokenFrom(address account, uint256 amount) external nonpayable
```



*Pool controller can burn anyone&#39;s tokens*
...
*Getter for a pool controller address*
...
*Pool controller can mint tokens to anyone*
...
*Setter for a pool controller address*

#### Parameters

| Name | Type | Description |
|---|---|---|
| poolControllerAddress | address | undefined |
...
*Checks if this contract supports interface*
