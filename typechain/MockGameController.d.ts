...
interface MockGameControllerInterface extends ethers.utils.Interface {
  functions: {
...
export class MockGameController extends Contract {
  ...
  interface: MockGameControllerInterface;
